...
class CreateProductService {
  ...
  public async execute({ customer_id, products }: IRequest): Promise<Order> {
    /* Verifica se o Cliente existe caso não exista retorna um error */
    ...
    if (!customerExist) {
     ...
     /* Obtem dentro do array produtos os Ids, depois realiza a pesquisa a procura dos produtos na base */
    ...
    /* Gera uma cosntante do tipo IUpdateProductsQuantityDTO[] e inicializa com array vazio
       para ser utilizado como produtos que terão suas quantidades alteradas
    */
